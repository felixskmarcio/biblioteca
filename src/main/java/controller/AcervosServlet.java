...
public class AcervosServlet extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response) 
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            out.println("                </h2>");
            out.println("                <div>");
            out.println("                    <button type=\"button\" class=\"btn btn-success me-2\" data-bs-toggle=\"collapse\" data-bs-target=\"#formCadastroLivro\" aria-expanded=\"false\" aria-controls=\"formCadastroLivro\">");
            out.println("                        <i class=\"bi bi-plus-circle\"></i> Cadastrar Livro");
            out.println("                    </button>");
            ...
            out.println("        <div class=\"collapse mb-4\" id=\"formCadastroLivro\">");
            out.println("            <div class=\"card\">");
            out.println("                <div class=\"card-header bg-success text-white\">");
            out.println("                    <h5 class=\"mb-0\">Cadastrar Novo Livro</h5>");
            out.println("                </div>");
            out.println("                <div class=\"card-body\">");
            out.println("                    <form action=\"" + request.getContextPath() + "/processarCadastroLivro.jsp\" method=\"POST\">");
            out.println("                        <div class=\"row\">");
            out.println("                            <div class=\"col-md-6 mb-3\">");
            out.println("                                <label for=\"title\" class=\"form-label\">Título*</label>");
            out.println("                                <input type=\"text\" class=\"form-control\" id=\"title\" name=\"title\" required>");
            out.println("                            </div>");
            out.println("                            ");
            out.println("                            <div class=\"col-md-6 mb-3\">");
            out.println("                                <label for=\"author\" class=\"form-label\">Autor*</label>");
            out.println("                                <input type=\"text\" class=\"form-control\" id=\"author\" name=\"author\" required>");
            out.println("                            </div>");
            out.println("                        </div>");
            out.println("                        ");
            out.println("                        <!-- Campos ocultos com valores padrão -->");
            out.println("                        <input type=\"hidden\" name=\"isbn\" value=\"N/A\">");
            out.println("                        <input type=\"hidden\" name=\"totalQuantity\" value=\"1\">");
            out.println("                        <input type=\"hidden\" name=\"availableQuantity\" value=\"1\">");
            out.println("                        ");
            out.println("                        <div class=\"d-grid gap-2 d-md-flex justify-content-md-end mt-3\">");
            out.println("                            <button type=\"button\" class=\"btn btn-outline-secondary me-md-2\" data-bs-toggle=\"collapse\" data-bs-target=\"#formCadastroLivro\">");
            out.println("                                Cancelar");
            out.println("                            </button>");
            out.println("                            <button type=\"submit\" class=\"btn btn-success\">");
            out.println("                                <i class=\"bi bi-save\"></i> Salvar Livro");
            out.println("                            </button>");
            out.println("                        </div>");
            out.println("                    </form>");
            out.println("                </div>");
